...
const (
	// RecommendedHomeDir defines the default directory used to place all ctl service configurations.
	RecommendedHomeDir = ".ctl"

	// RecommendedEnvPrefix defines the ENV prefix used by all ctl service.
	RecommendedEnvPrefix = "CTL"
)
